...
import com.project.model.enums.BusinessStatus;
import com.project.service.SysOperLogService;
import com.project.util.SecurityUtils;
import com.project.util.ServletUtils;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.project.aop.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
        try {
            ...
            // 获取当前的用户
            SysUserEntity currentUser = SecurityUtils.getLoginUser(request);
